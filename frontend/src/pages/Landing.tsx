...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative thermal-overlay">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-background/80 backdrop-blur-xl border-b border-border">
        ...
        <div className="flex items-center gap-6">
          ...
          <span className="px-3 py-1 rounded border border-primary/20 text-[10px] font-mono text-primary/60 tracking-widest">LA DEMO</span>
        </div>
      </nav>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-24 pb-16 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/20 text-[10px] font-mono text-primary/60 tracking-widest mb-8">
            <span className="h-1.5 w-1.5 rounded-full bg-primary animate-pulse" />
            THERMAL SCAN ACTIVE
          </div>
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-display font-bold tracking-tight text-foreground mb-6 leading-[1.1]">
            Find the best areas
            <br />
            <span className="text-primary neon-text">in Los Angeles.</span>
          </h1>
          <p className="text-sm sm:text-base font-mono text-muted-foreground max-w-lg mx-auto mb-10 leading-relaxed tracking-wide">
          ...
          <motion.button
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded bg-primary text-primary-foreground font-mono font-bold text-sm tracking-widest uppercase shadow-[0_0_40px_hsl(var(--primary)/0.25)] hover:shadow-[0_0_60px_hsl(var(--primary)/0.35)] transition-shadow duration-300"
          >
        ...
        >
          {benefits.map((b, i) => (
            <motion.div
              ...
              className="rounded border border-border bg-card/50 p-5 hover:border-primary/20 transition-colors duration-300 neon-border"
            >
        ...
        <p className="text-[9px] font-mono text-muted-foreground/50 mt-16 text-center tracking-widest uppercase">
